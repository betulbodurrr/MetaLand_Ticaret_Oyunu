...
CREATE TABLE `calisan` (
  ...
  `isBaslangic` varchar(255) DEFAULT NULL,
  `isBitis` varchar(255) DEFAULT NULL,
  `calisilanGun` int DEFAULT NULL,
  `calismaSaat` float DEFAULT NULL,
  `isletmeTuru` varchar(255) DEFAULT NULL,
  `isletmeID` int DEFAULT NULL,
...
INSERT INTO `calisan` VALUES (1,'27.5.2023','6.6.2023',1,24,'emlak',2);
...
-- Dump completed on 2023-05-28 20:22:54
