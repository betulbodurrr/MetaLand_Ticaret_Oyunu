...
CREATE TABLE `islem` (
  `alanNo` int NOT NULL,
  `satisTarihi` varchar(255) DEFAULT NULL,
  `kiraSuresi` varchar(255) DEFAULT NULL,
  `kiraBaslangic` varchar(255) DEFAULT NULL,
  `kiraBitis` varchar(255) DEFAULT NULL,
  `emlakNo` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`alanNo`)
